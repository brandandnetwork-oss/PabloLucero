        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
              <p>
                Tras iniciarme en el ciclismo a los 9 años, encontré en el triatlón y en el running mi verdadera vocación. Cuento con más de 11 años de experiencia como técnico de la Selección Española, participando en campeonatos mundiales y teniendo el honor de dirigir a una atleta en los Juegos Paralímpicos de París 2024.
              </p>
            </div>

            <Link to="/about" className="flex items-center gap-3 text-[#0095ff] font-bold text-lg group">
